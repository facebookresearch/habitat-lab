...
🆕Example code-snippet which uses [`habitat-lab/habitat/config/tasks/rearrange/pick.yaml`](habitat-lab/habitat/config/tasks/rearrange/pick.yaml) for configuration of task and agent.
