...
1. **Non-interactive testing**: Test the Pick task: Run the example pick task script
    ...
    which uses [`habitat-lab/habitat/config/benchmark/rearrangement/pick.yaml`](habitat-lab/habitat/config/benchmark/rearrangement/pick.yaml) for configuration of task and agent.
