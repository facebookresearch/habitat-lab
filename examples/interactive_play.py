...
Change the task with `--cfg habitat-lab/habitat/config/tasks/rearrange/close_cab.yaml` (choose any task under the `configs/tasks/rearrange/` folder).
...
DEFAULT_CFG = "habitat-lab/habitat/config/tasks/rearrange/play.yaml"
