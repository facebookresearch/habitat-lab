...
Change the task with `--cfg habitat/config/tasks/rearrange/close_cab.yaml` (choose any task under the `habitat/config/tasks/rearrange/` folder).
...
DEFAULT_CFG = "habitat/config/tasks/rearrange/play.yaml"
