...
class AppStateIsaacRearrange(AppState):
    """
    A HITL app that loads and steps a Rearrange environment using Isaac integration.
    """
...
@hydra.main(version_base=None, config_path="./", config_name="isaac_rearrange")
def main(config):
    hitl_main(config, lambda app_service: AppStateIsaacRearrange(app_service))
