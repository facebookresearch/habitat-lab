...
class EndEpisodeForm:
    ...
    def __init__(
        ...
        self._state: EndEpisodeForm.State = EndEpisodeForm.State.END_EPISODE_FORM
    ...
    def _show_failure_form(self) -> Result:
        ...
        textbox_report_confirmation = UITextbox(id_textbox, self._error_report_text, enabled=False)
        self._app_service.client_message_manager.show_modal_dialogue_box(
            "Error Reported",
            "Waiting for the other participant to finish...",
            buttons,
