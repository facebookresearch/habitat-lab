...
from app_states import create_app_state_rearrange, create_app_state_reset
...
class StateMachineShort(AppState):
    """
    Short state machine for app testing.
    """
    ...
    def sim_update(self, dt: float, post_sim_update_dict):
        if self._app_state is None:
            ...
            self._app_state = create_app_state_rearrange(
                self._app_service, self._app_data, session, short_circuit=True
            )
