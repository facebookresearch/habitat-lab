...
from spatialmath import SE3, SO3, Quaternion
...
def pos(
            ...
            R = (Quaternion([q.w, q.x, q.y, q.z])).unit().SE3()
            t = SE3([v.x, v.y, v.z])
            pose = t * R
...
class QuestReader:
    ...
    def set_origin(self):
        ...
        self.origin.t = [self.origin.t[0]+0.3, self.origin.t[1]-0.3, self.origin.t[2]+0.25]
