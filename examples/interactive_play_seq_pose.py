...
DEFAULT_POSE_PATH = "data/humanoids/humanoid_data/mdm_data/back4_sample00_rep01.pkl"
DEFAULT_CFG = "benchmark/rearrange/play_human.yaml"
...
def get_input_vel_ctlr(
    ...
    if control_humanoid:
        if humanoid_controller is None:
            ...
            humanoid_controller.get_pose_mdm()
...
def play_env(env, args, config):
    ...
    if args.use_humanoid_controller:
        humanoid_controller = SeqPoseController(args.motion_pose_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--motion-pose-path", type=str, default=DEFAULT_POSE_PATH)
