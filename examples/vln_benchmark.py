...
def main():
    ...
    for agent_name in ['RandomAgent', 'ForwardOnlyAgent', 'RandomForwardAgent', 'GoalFollower']:
        agent = getattr(sys.modules[__name__], agent_name)
        agent = agent(config_env.TASK.SUCCESS_DISTANCE, config_env.TASK.GOAL_SENSOR_UUID)
