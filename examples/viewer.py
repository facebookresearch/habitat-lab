...
class HabitatSimInteractiveViewer(Application):
    ...
    def __init__(self, sim_settings: Dict[str, Any]) -> None:
        ...
        self.tiled_sims: list[habitat_sim.Simulator] = None
        ...
        if key == pressed.ESC:
            ...
            if not alt_pressed:
                ...
                if self.sim_settings["scene"] not in scene_ids:
                    ...
                    cur_scene_index = scene_ids.index(
                        self.sim_settings["scene"]
                    )
            ...
            demo_mode_ix = self.demo_modes.index(self.demo_mode)
            demo_mode_ix = (demo_mode_ix + 1) % len(self.demo_modes)
            self.demo_mode = self.demo_modes[demo_mode_ix]
            logger.info(f"Demo mode set to '{self.demo_mode}'")
