...
@hydra.main(
    version_base=None,
    config_path="../../examples/hitl/basic_viewer/config",
    config_name="basic_viewer",
)
def test_hitl_basicviewer(config):
    ...
    assert "Basic Viewer app failed" in str(e.value)


if __name__ == "__main__":
    register_hydra_plugins()
    test_hitl_basicviewer()
