...
# TODO there was a change here to make the difference an integer.
#  Now the bounds have been moved to pathfinder, if needed it might
...
def to_grid(
    ...
    grid_x = (realworld_x - lower_bound[2]) / grid_size[0]
    grid_y = (realworld_y - lower_bound[0]) / grid_size[1]
    if keep_float:
