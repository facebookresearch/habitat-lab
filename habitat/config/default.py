...
_C.TASK.PICKED_OBJECT_CATEGORY = CN()
_C.TASK.PICKED_OBJECT_CATEGORY.TYPE = "PickedObjectCategory"
...
_C.TASK.PICK_REWARD.SPARSE_REWARD = False
...
_C.TASK.PLACE_REWARD.SPARSE_REWARD = False
...
_C.TASK.PLACE_SUCCESS.STABILITY_CHECK = False
_C.TASK.PLACE_SUCCESS.USE_PDDL_SUCCESS = False

_C.TASK.STABILITY = CN()
_C.TASK.STABILITY.TYPE = "Stability"
_C.TASK.STABILITY.MIN_STABLE_DURATION = 10
# -----------------------------------------------------------------------------
...
_C.SIMULATOR.SEMANTIC_SENSOR.UUID = "semantic_sensor"
# -----------------------------------------------------------------------------
# EQUIRECT RGB SENSOR
# -----------------------------------------------------------------------------
