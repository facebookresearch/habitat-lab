    ...
    def _add_objs(self, ep_info: Config, should_add_objects: bool) -> None:
        ...
        for i, (obj_handle, transform) in enumerate(ep_info["rigid_objs"]):
            if should_add_objects:
                ...
                ), f"Duplicate object attributes matched to shortened handle. '{obj_handle}' matched to {matching_templates}. TODO: relative paths as handles should fix this. For now, try renaming objects to avoid collision."
