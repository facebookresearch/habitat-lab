...
RUN /bin/bash -c ". activate habitat; cd habitat-sim; git checkout 00cddeee6d66108e277dc5b36006bf3eab03a291; pip install -r requirements.txt; python setup.py install--headless"
