...
class HumanPickPolicy(NnSkillPolicy):
    @dataclass
    ...
    def _is_skill_done(
        ...
        finish_oracle_nav = observations[
            HasFinishedHumanPickSensor.cls_uuid
        ].cpu()
    ...
    def _parse_skill_arg(self, skill_arg):
        ...
        return HumanPickPolicy.HumanoidPickActionArgs(match_i)

    @property
    def required_obs_keys(self):
        ret = [HasFinishedHumanPickSensor.cls_uuid]
    ...
    def _internal_act(
        ...
        full_action[:, self._oracle_nav_ac_idx + 1] = 1
...
class HumanPlacePolicy(HumanPickPolicy):
    def _internal_act(
        self,
        observations,
        rnn_hidden_states,
        ...
        full_action[:, self._oracle_nav_ac_idx] = action_idxs
        full_action[:, self._oracle_nav_ac_idx + 1] = 0
