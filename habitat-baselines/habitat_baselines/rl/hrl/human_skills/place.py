...
class HumanPlaceSkillPolicy(NnSkillPolicy):
    @dataclass
    class HumanPlaceActionArgs:
        """
    ...
    def __init__(
        ...
        self._oracle_nav_ac_idx, _ = find_action_range(
            action_space, "human_place_action"
        )
    ...
    def _parse_skill_arg(self, skill_arg):
        ...
        return HumanPlaceSkillPolicy.HumanPlaceActionArgs(match_i)
