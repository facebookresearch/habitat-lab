...
class FixedHighLevelPolicy(HighLevelPolicy):
    ...
    # TODO: better way to implenment this
    def filter_envs(self, curr_envs_to_keep_active):
        ...
        parse_solution_actions_alive = []
        for i in range(curr_envs_to_keep_active.shape[0]):
            if curr_envs_to_keep_active[i]:
                parse_solution_actions_alive.append(parse_solution_actions[i])
        self._update_solution_actions(parse_solution_actions_alive)
