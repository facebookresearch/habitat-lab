...
do
  ...
  do
    ...
    ##################################
    # # Ours
    python scripts/hab2_benchmark.py --cfg configs/tasks/rearrange/benchmark/idle.yaml --n-steps "$NUM_STEPS" --n-procs "$j" --n-gpus ${N_GPU} --out-name "all_$i"
    ...
    # # Ours
    python scripts/hab2_benchmark.py --cfg configs/tasks/rearrange/benchmark/idle_single_camera.yaml --n-steps "$NUM_STEPS" --n-procs "$j" --n-gpus ${N_GPU} --out-name "all_$i"
