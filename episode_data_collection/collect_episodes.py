...
if __name__ == "__main__":
    ...
    parser.add_argument("--every-view", action="store_true", default=False, help="At each forward step, collect views in 4 directions (0,90,180,270 deg).")
    parser.add_argument("--sample", type=float, default=0.0, help="Fraction of episodes to randomly skip")
    parser.add_argument("--save-per-scene", action="store_true", default=False)
    parser.add_argument("--describe-goal", action="store_true", default=False, help="Use BLIP to describe the goal image.")
    parser.add_argument("--eval-model", type=str, default=None, help="Path to model to evaluate along the generated episodes.")
    parser.add_argument("--collect-surface-points", action="store_true", default=False, help="Collect surface points for GeoNoise computation along the trajectory.")
