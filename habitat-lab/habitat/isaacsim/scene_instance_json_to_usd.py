...
def object_usd_info(obj_instance_json, object_counts):
    ...
    return object_config_filename, out_usd_path, object_counts, unique_object_name
...
def convert_object_to_usd(objects_folder: str, object_config_filename: str, out_usd_path; str, project_root_folder; str) -> None:
...
def convert_hab_scene(scene_filepath: str, project_root_folder: str, objects_folder: str = '', scene_usd_filepath: str= "./data/test_scene_instance.usda") -> None:
    """
    ...
    for obj_instance_json in scene_json_data["object_instances"]:
        ...
        object_config_filename, out_usd_path, object_counts, unique_object_name = object_usd_info(obj_instance_json, object_counts)
