...
class RearrangeEpisodeGenerator:
    ...
    def __init__(
        ...
        # KL: add start and goal for robot agent
    ...
    def generate_single_episode(self) -> Optional[RearrangeEpisode]:
        ...
        for sampler_name, target_sampler in self._target_samplers.items():
            ...
            for target_handle, (
                ...
                # KL: set goal position if applicable
                self.robot_goal_pos = new_target_obj.translation
        ...
        return RearrangeEpisode(
            ...
            goal_position=self.robot_goal_pos,  #KL: add
