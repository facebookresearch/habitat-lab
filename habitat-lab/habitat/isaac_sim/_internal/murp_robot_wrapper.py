...
class MurpRobotWrapper:
    ...
    def get_link_id(self, link_str: str) -> int:
        print(f"get_link_id({link_str}) - ")
        print(f"    self._body_prim_paths = {self._body_prim_paths}")
        return [
    ...
    def reset_hand(self):
        ...
        left_hand_joint_names = [
            ...
            "allegro_joint_one_12",
            "allegro_joint_one_13",
            "allegro_joint_one_14",
            "allegro_joint_one_15",
        ]
        right_hand_joint_names = [
            ...
            "allegro_joint_two_12",
            "allegro_joint_two_13",
            "allegro_joint_two_14",
            "allegro_joint_two_15",
        ]
