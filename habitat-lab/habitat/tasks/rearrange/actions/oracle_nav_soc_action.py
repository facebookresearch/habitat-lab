...
class OracleNavSocAction(BaseVelAction, HumanoidJointAction):
    ...
    def _get_random_waypoint(self):
        ...
        #while abs(navigable_point[1] - self.prev_navigable_point[1]) >= 0.1 or self._get_distance(self.prev_navigable_point, navigable_point) <=4: #add distance measure too
