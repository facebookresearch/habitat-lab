...
class PointNavResNetPolicy(NetPolicy):
    ...
    def from_config(
        ...
        return cls(
            ...
            # normalize_visual_inputs=RGB_KEY in observation_space.spaces,
...
class ResNetEncoder(nn.Module):
    def __init__(
        ...
        if RGB_KEY in observation_space.spaces:
            ...
            self.spatial_size = observation_space.spaces[RGB_KEY].shape[
                0:2
        ...
        if DEPTH_KEY in observation_space.spaces:
            ...
            self.spatial_size = observation_space.spaces[DEPTH_KEY].shape[
                0:2
            ]  # todo: decide whether to divide by 2

            # self._n_input_depth = observation_space.spaces[DEPTH_KEY].shape[0] + 10
            # self.spatial_size = observation_space.spaces[DEPTH_KEY].shape[1:]
        else:
