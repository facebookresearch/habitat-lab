...
def build_PPO_config(config_path="pointnav/ppo_pointnav.yaml"):
    ...
    config.habitat_baselines.total_num_steps = 250 * 1000
    ...
    config.habitat_baselines.rl.ppo.hidden_size = 128
